...
def build_parser() -> argparse.ArgumentParser:
    ...
    create_disposable_binding.add_argument("--worker-codex-app-thread-id", help="Optional Codex app thread id for the worker session.")
    create_disposable_binding.add_argument("--worker-codex-app-thread-title", help="Optional Codex app thread title for the worker session.")
    create_disposable_binding.add_argument("--manager-codex-app-thread-id", help="Optional Codex app thread id for the manager session.")
    create_disposable_binding.add_argument("--manager-codex-app-thread-title", help="Optional Codex app thread title for the manager session.")
    ...
    register_worker.add_argument("--codex-app-thread-id", help="Optional Codex app thread id for app-assisted setup.")
    register_worker.add_argument("--codex-app-thread-title", help="Optional human-readable Codex app thread title.")
    ...
    register_manager.add_argument("--codex-app-thread-id")
    register_manager.add_argument("--codex-app-thread-title")
