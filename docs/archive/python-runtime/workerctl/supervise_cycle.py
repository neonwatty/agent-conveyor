    ...
    *,
    ...
    return {
        ...
        "suggested_actions": [
            ...
            f"Record accepted current-task criteria with conveyor criteria {task_arg} --add --criterion \"...\" --source worker_proposed --status accepted.",
            f"Record proposed current-task criteria with conveyor criteria {task_arg} --add --criterion \"...\" --source worker_proposed --status proposed.",
            f"Record follow-up criteria with conveyor criteria {task_arg} --add --criterion \"...\" --source worker_proposed --status deferred.",
        ],
    }
